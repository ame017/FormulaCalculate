 ...
 */
@property (copy) void (^event) (AMEButton * button);

/**
 我居然忘写这个了...(buttonType)
 */
@property (nonatomic, assign) AMEButtonType ameButtonType;
 ...
 */
+ (instancetype)buttonWithType:(AMEButtonType)buttonType event:(void (^)(AMEButton * button))event;
